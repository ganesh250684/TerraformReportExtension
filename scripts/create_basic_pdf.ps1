...
<body>
    ...
    <div class="page-footer">
        <span>Generated using: <a href="https://marketplace.visualstudio.com/items?itemName=cloudcraft.terraform-report-generator" target="_blank">Terraform Report Generator for VS Code</a></span>
    </div>
</body>
</html>
"@
